! function() {
    ...
    }), sessionStorage.setItem("defaultAttribute", JSON.stringify(h)), e(h), (L = document.querySelector('.btn[data-bs-target="#theme-settings-offcanvas"]')) && L.click()), document.getElementById("sidebarUserProfile"), document.addEventListener("click", function(e) {
