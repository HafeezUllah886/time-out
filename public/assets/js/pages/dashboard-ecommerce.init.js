...
function loadCharts() {
    ...
    t &&
        ...
        (worldemapmarkers = new jsVectorMap({
            ...
            zoomButtons: !1,
            selectedMarkers: [0, 5],
            regionStyle: { initial: { stroke: "#9599ad", strokeWidth: 0.25, fill: t[0], fillOpacity: 1 } },
            markersSelectable: !0,
            markers: [
            ...
            markerStyle: { initial: { fill: t[1] }, selected: { fill: t[2] } },
            labels: {
                markers: {
                    render: function (e) {
                        return e.name;
        ...
        (t = getChartColorsArray("customer_impression_charts")) &&
            ...
            (customerImpressionChart = new ApexCharts(document.querySelector("#customer_impression_charts"), e)).render());
    (t = getChartColorsArray("store-visits-source")) &&
        ((e = {
        ...
        "" != storeVisitsSourceChart && storeVisitsSourceChart.destroy(),
        (storeVisitsSourceChart = new ApexCharts(document.querySelector("#store-visits-source"), e)).render());
}
