        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header row">
                    <div class="col-6"><h3> Purchase Payments </h3></div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            @endif
                            <form action="{{ route('purchase_payment.store') }}" method="post">
                                @csrf
                                    ...
                                    @foreach ($purchase->payments as $payment)
                                        <tr>
                                            ...
                                            <td class="text-center"><a
                                                    href="{{ route('purchasePayment.delete', [$purchase->id, $payment->refID]) }}"
